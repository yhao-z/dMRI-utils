...
Samp = zeros(n1,n2,n3);
for frameno = 1:n3
  y=ceil(-n1/2:1:n1/2);  % Create an array of N points between -n1/2 and n1/2
  y(end) = [];
  x=ceil(linspace(-n2/2,n2/2,length(y)+1));
  x(end) = [];
  i=1;
...
kloc1 = floor(kcart+(floor(n1/2+1)+floor(n2/2+1)*1i));
